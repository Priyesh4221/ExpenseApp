//
//  ShowallmyofficeexpensesTableViewCell.swift
//  Expenseapp
//
...
class ShowallmyofficeexpensesTableViewCell: UITableViewCell {
    ...
    func udpdate(x : fetchofficeexpenses , y : String)
       {
